                    ...
                    switch (form[key].type) {
                        ...
                        case "image_url":
                            if (gdata !== "http://" && gdata !== "https://" && gdata !== "") {
                                ...
                                } else if (gdata.slice(0, 7) == "http://" || gdata.slice(0, 8) == "https://") { // 絶対パス指定
                                    chtml += `<div class="col-12"><img class="thumbnail" onclick="modalActs.viewImage(this)" src="${gdata}"></div>`;
                                } else {    // 相対パス指定
                                    let rurl = Conf.etc.relativePath
                                    chtml += `<div class="col-12"><img class="thumbnail" onclick="modalActs.viewImage(this)" src="${rurl + gdata}"></div>`;
                                }
                            }
                            break;
                        default: // 何もしない
